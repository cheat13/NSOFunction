...
public interface IWaterFunction
{
    ...
    /// </summary>
    int HasntPlumbing(Plumbing Plumbing, bool? IsHouseHold, bool? IsAgriculture, bool? IsFactorial, bool? IsCommercial);
    ...
    /// </summary>
    List<WaterPoolHouseHold> WaterSourcesHouseHold(string ea, bool? IsHouseHold, bool? IsAgriculture, bool? IsFactorial, bool? IsCommercial, Pool Pools);
