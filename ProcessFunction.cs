        ...
        public List<DataProcessed> UnitProcessing(string ea, HouseHoldSample unt, BuildingSample bld, List<CommunitySample> com)
        {
            ...
            else
            {
                ...
                var localDataProcessed = new DataProcessed
                {
                    ...
                    CubicMeterPlumbingForAgricultureMWA = cubicMeterPlumbing.CubicMeterPlumbingForAgricultureMWA,
                    CubicMeterPlumbingForAgriculturePWA = cubicMeterPlumbing.CubicMeterPlumbingForAgriculturePWA,
                    CubicMeterPlumbingForAgricultureOther = cubicMeterPlumbing.CubicMeterPlumbingForAgricultureOther,
                    CubicMeterPlumbingForAgriculture = cubicMeterPlumbing.CubicMeterPlumbingForAgriculture,
                    CubicMeterPlumbingForServiceMWA = cubicMeterPlumbing.CubicMeterPlumbingForServiceMWA,
                    CubicMeterPlumbingForServicePWA = cubicMeterPlumbing.CubicMeterPlumbingForServicePWA,
                    CubicMeterPlumbingForServiceOther = cubicMeterPlumbing.CubicMeterPlumbingForServiceOther,
                    CubicMeterPlumbingForService = cubicMeterPlumbing.CubicMeterPlumbingForService,
                    CubicMeterPlumbingForProductMWA = cubicMeterPlumbing.CubicMeterPlumbingForProductMWA,
                    CubicMeterPlumbingForProductPWA = cubicMeterPlumbing.CubicMeterPlumbingForProductPWA,
                    CubicMeterPlumbingForProductOther = cubicMeterPlumbing.CubicMeterPlumbingForProductOther,
                    CubicMeterPlumbingForProduct = cubicMeterPlumbing.CubicMeterPlumbingForProduct,
                    CubicMeterPlumbingForDrinkMWA = cubicMeterPlumbing.CubicMeterPlumbingForDrinkMWA,
                    CubicMeterPlumbingForDrinkPWA = cubicMeterPlumbing.CubicMeterPlumbingForDrinkPWA,
                    CubicMeterPlumbingForDrinkOther = cubicMeterPlumbing.CubicMeterPlumbingForDrinkOther,
                ...
                var dataProcessedList = countGroundWaterProcessed
                    ...
                    .Select(it => new DataProcessed
                    {
                        ...
                        CubicMeterGroundWaterForAgricultureGroundWater = it.Sum(i => i.CubicMeterGroundWaterForAgricultureGroundWater),
                        CubicMeterGroundWaterForAgricultureBuying = it.Sum(i => i.CubicMeterGroundWaterForAgricultureBuying),
                        CubicMeterGroundWaterForAgriculture = it.Sum(i => i.CubicMeterGroundWaterForAgriculture),
                        CubicMeterGroundWaterForServiceGroundWater = it.Sum(i => i.CubicMeterGroundWaterForServiceGroundWater),
                        CubicMeterGroundWaterForServiceBuying = it.Sum(i => i.CubicMeterGroundWaterForServiceBuying),
                        CubicMeterGroundWaterForService = it.Sum(i => i.CubicMeterGroundWaterForService),
                        CubicMeterGroundWaterForProductGroundWater = it.Sum(i => i.CubicMeterGroundWaterForProductGroundWater),
                        CubicMeterGroundWaterForProductBuying = it.Sum(i => i.CubicMeterGroundWaterForProductBuying),
                        CubicMeterGroundWaterForProduct = it.Sum(i => i.CubicMeterGroundWaterForProduct),
                        CubicMeterGroundWaterForDrinkGroundWater = it.Sum(i => i.CubicMeterGroundWaterForDrinkGroundWater),
                        CubicMeterGroundWaterForDrinkBuying = it.Sum(i => i.CubicMeterGroundWaterForDrinkBuying),
                        CubicMeterGroundWaterForDrink = it.Sum(i => i.CubicMeterGroundWaterForDrink),
                        CubicMeterPlumbingForAgricultureMWA = it.Sum(i => i.CubicMeterPlumbingForAgricultureMWA),
                        CubicMeterPlumbingForAgriculturePWA = it.Sum(i => i.CubicMeterPlumbingForAgriculturePWA),
                        CubicMeterPlumbingForAgricultureOther = it.Sum(i => i.CubicMeterPlumbingForAgricultureOther),
                        CubicMeterPlumbingForAgriculture = it.Sum(i => i.CubicMeterPlumbingForAgriculture),
                        CubicMeterPlumbingForServiceMWA = it.Sum(i => i.CubicMeterPlumbingForServiceMWA),
                        CubicMeterPlumbingForServicePWA = it.Sum(i => i.CubicMeterPlumbingForServicePWA),
                        CubicMeterPlumbingForServiceOther = it.Sum(i => i.CubicMeterPlumbingForServiceOther),
                        CubicMeterPlumbingForService = it.Sum(i => i.CubicMeterPlumbingForService),
                        CubicMeterPlumbingForProductMWA = it.Sum(i => i.CubicMeterPlumbingForProductMWA),
                        CubicMeterPlumbingForProductPWA = it.Sum(i => i.CubicMeterPlumbingForProductPWA),
                        CubicMeterPlumbingForProductOther = it.Sum(i => i.CubicMeterPlumbingForProductOther),
                        CubicMeterPlumbingForProduct = it.Sum(i => i.CubicMeterPlumbingForProduct),
                        CubicMeterPlumbingForDrinkMWA = it.Sum(i => i.CubicMeterPlumbingForDrinkMWA),
                        CubicMeterPlumbingForDrinkPWA = it.Sum(i => i.CubicMeterPlumbingForDrinkPWA),
                        CubicMeterPlumbingForDrinkOther = it.Sum(i => i.CubicMeterPlumbingForDrinkOther),
                        CubicMeterPlumbingForDrink = it.Sum(i => i.CubicMeterPlumbingForDrink),
                        CubicMeterSurfaceForAgriculturePool = it.Sum(i => i.CubicMeterSurfaceForAgriculturePool),
                        CubicMeterSurfaceForAgricultureRiver = it.Sum(i => i.CubicMeterSurfaceForAgricultureRiver),
                        CubicMeterSurfaceForAgricultureIrrigation = it.Sum(i => i.CubicMeterSurfaceForAgricultureIrrigation),
                        CubicMeterSurfaceForAgricultureRain = it.Sum(i => i.CubicMeterSurfaceForAgricultureRain),
                        CubicMeterSurfaceForAgriculture = it.Sum(i => i.CubicMeterSurfaceForAgriculture),
                        CubicMeterSurfaceForServicePool = it.Sum(i => i.CubicMeterSurfaceForServicePool),
                        CubicMeterSurfaceForServiceRiver = it.Sum(i => i.CubicMeterSurfaceForServiceRiver),
                        CubicMeterSurfaceForServiceIrrigation = it.Sum(i => i.CubicMeterSurfaceForServiceIrrigation),
                        CubicMeterSurfaceForServiceRain = it.Sum(i => i.CubicMeterSurfaceForServiceRain),
                        CubicMeterSurfaceForService = it.Sum(i => i.CubicMeterSurfaceForService),
                        CubicMeterSurfaceForProductPool = it.Sum(i => i.CubicMeterSurfaceForProductPool),
                        CubicMeterSurfaceForProductRiver = it.Sum(i => i.CubicMeterSurfaceForProductRiver),
                        CubicMeterSurfaceForProductIrrigation = it.Sum(i => i.CubicMeterSurfaceForProductIrrigation),
                        CubicMeterSurfaceForProductRain = it.Sum(i => i.CubicMeterSurfaceForProductRain),
                        CubicMeterSurfaceForProduct = it.Sum(i => i.CubicMeterSurfaceForProduct),
                        CubicMeterSurfaceForDrinkPool = it.Sum(i => i.CubicMeterSurfaceForDrinkPool),
                        CubicMeterSurfaceForDrinkRiver = it.Sum(i => i.CubicMeterSurfaceForDrinkRiver),
                        CubicMeterSurfaceForDrinkIrrigation = it.Sum(i => i.CubicMeterSurfaceForDrinkIrrigation),
                        CubicMeterSurfaceForDrinkRain = it.Sum(i => i.CubicMeterSurfaceForDrinkRain),
